...
(function (managers) {
    var ScoreBoard = /** @class */ (function () {
        ...
        ScoreBoard.prototype._initialize = function () {
            this._livesLabel = new objects.Label("Lives: 99", "20px", "Consolas", "#000080", 20, 20);
            this._scoreLabel = new objects.Label("Score: 99999", "20px", "Consolas", "#000080", 490, 20);
            this._highScoreLabel = new objects.Label("High Score: 99999", "40px", "Consolas", "#000080", 512, 290);
