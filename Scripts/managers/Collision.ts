                ...
                case enums.GameObjectType.BULLET:
                    {
                        ...
                        let hitID = Math.floor(util.Mathf.RandomRange(1, 2));
                        let hitSound = createjs.Sound.play("hit-" + hitID);
                        hitSound.volume = 0.2;
                    ...
                    break;
                case enums.GameObjectType.VIRUS:
                    {
                        console.log("Collision with Virus!");
                        let damageSound = createjs.Sound.play("damage");
